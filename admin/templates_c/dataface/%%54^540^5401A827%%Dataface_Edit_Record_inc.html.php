<?php /* Smarty version 2.6.18, created on 2014-05-20 12:53:11
...
/css/jquery.tabs-ie.css';
    ...
    <div class="tabs-panel">
        <div><?php $this->_tag_stack[] = array('translate', array('id' => 'Remember to press save')); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Remember to press <em>保存</em> when you're done.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div>
<?php endif; ?>
